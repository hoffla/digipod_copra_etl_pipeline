...
class SozialeSituationScoreDeserializer(BaseDeserializer):
    def deserialize(self) -> SocialSituationScore:
        total_score = self._parse_int_value('.//SUB_DOC/SUB_DOC_CONTENT/QVDELIN373')
        not_collected = XMLDeserializerHelper.determine_yes_no_value(self._get_element_value('.//SUB_DOC/SUB_DOC_CONTENT/QVDELIN418'))
        question_0 = XMLDeserializerHelper.determine_yes_no_value(self._get_element_value('.//SUB_DOC/SUB_DOC_CONTENT/QVDELIN419'))

        question_1 = self._map_value(self._get_element_value('.//SUB_DOC/SUB_DOC_CONTENT/QVDELIN420'), {
        ...
        question_2 = self._map_value(self._get_element_value('.//SUB_DOC/SUB_DOC_CONTENT/QVDELIN421'), {
            "0": "Nein", "1": "Ja", "": "k.A."
        })

        question_3 = self._map_value(self._get_element_value('.//SUB_DOC/SUB_DOC_CONTENT/QVDELIN422'), {
            "11": "mehrmals täglich/jeden Tag", "21": "ein-/mehrmalig in der Woche",
            "30": "selten (ein bis zweimal im Monat)", "40": "(fast) nie", "": "k.A."
        })

        question_4 = self._map_value(self._get_element_value('.//SUB_DOC/SUB_DOC_CONTENT/QVDELIN423'), {
            "0": "Beziehung teilweise konfliktbeladen und gespannt", "1": "Beziehung harmonisch und vertrauensvoll",
            "": "k.A."
        })

        question_5 = self._map_value(self._get_element_value('.//SUB_DOC/SUB_DOC_CONTENT/QVDELIN424'), {
        ...
        question_6 = self._map_value(self._get_element_value('.//SUB_DOC/SUB_DOC_CONTENT/QVDELIN425'), {
